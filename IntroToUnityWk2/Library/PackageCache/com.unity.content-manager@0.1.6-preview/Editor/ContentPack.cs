...
namespace Unity.ContentManager
{
    ...
    {
        static readonly string[] k_ContentPackLabel = { ContentManagerDriver.ContentPackLabel };
...
#pragma warning restore 649
        ...
        void OnReset()
        {
            EditorApplication.delayCall += EnsureContentPackLabel;
        }
        ...
        void EnsureContentPackLabel()
        {
            if (this != null)
                AssetDatabase.SetLabels(this, k_ContentPackLabel);
        }
    }
}
