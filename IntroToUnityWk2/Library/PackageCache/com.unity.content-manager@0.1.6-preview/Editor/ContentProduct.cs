...
namespace Unity.ContentManager
{
    ...
    {
        static readonly string[] k_ContentProductLabel = { ContentManagerDriver.ContentProductLabel };
...
#pragma warning restore 649
        ...
        void OnReset()
        {
            EditorApplication.delayCall += EnsureContentProductLabel;
        }
        ...
        void EnsureContentProductLabel()
        {
            if (this != null)
                AssetDatabase.SetLabels(this, k_ContentProductLabel);
        }
    }
}
