    ...
    public sealed class DepthSubsystem : XRDepthSubsystem, IMarsXRSubsystem
    {
...
#endif
        {
                ...
                Allocator allocator)
            {
                ...
                var added = m_PointClouds.Keys.Except(m_PreviousIds);
                var updated = m_PointClouds.Keys.Intersect(m_PreviousIds);
                var removed = m_PreviousIds.Except(m_PointClouds.Keys);
                ...
                m_PreviousIds.Clear();
                m_PreviousIds.AddRange(m_PointClouds.Keys);
