...
#endif // ARFOUNDATION_3_0_1_OR_NEWER

namespace Unity.MARS.XRSubsystem.Simulation
{
    /// <summary>
    /// In editor copy of <see cref="ARBackgroundRendererFeature"/> where the editor defines have been inverted
    /// This is to allow in editor rendering
    /// </summary>
    class SimulatedBackgroundRenderFeature : ScriptableRendererFeature
    {
#if ARFOUNDATION_3_0_1_OR_NEWER
        /// <summary>
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (currentCamera.cameraType == CameraType.Game)
            {
...
namespace Unity.MARS.XRSubsystem.Simulation
{
    class SimulatedBackgroundRenderFeature : ScriptableObject {}
}
