namespace Unity.MARS
{
    class DocumentationConstants
    {
        ...
        const string k_CurrentMarsDocsVersion = "1.4";
        ...
        const string k_ReferenceGraphicsGuideDocBase = "Graphics";
        ...
        const string k_GraphicsBase = k_ManualLatest + k_ReferenceGraphicsGuideDocBase + k_PageAndAnchor;
        ...
        // Graphics
        internal const string GraphicsCompositeRenderOptions = k_GraphicsBase + "composite-render-options";
        internal const string GraphicsSupportedRenderingModes = k_GraphicsBase + "supported-rendering-modes";
        internal const string GraphicsARBackgroundSetup =  k_GraphicsBase + "ar-background-setup-in-unity-mars";
        internal const string GraphicsARBackgroundSetupURP =  k_GraphicsBase + "configuring-arcamerabackground-with-the-universal-render-pipeline";
    }
}
