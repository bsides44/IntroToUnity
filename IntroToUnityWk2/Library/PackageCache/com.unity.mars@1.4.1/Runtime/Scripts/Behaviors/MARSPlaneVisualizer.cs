...
namespace Unity.MARS.Visualizers
{
    ...
    public class MARSPlaneVisualizer : MonoBehaviour, IUsesPlaneFinding, IUsesCameraOffset, ISimulatable
    {
        class PlaneVisual
        {
...
#pragma warning disable 649
        [SerializeField]
        [Tooltip("Prefab to instantiate when creating planes.")]
        GameObject m_PlanePrefab;
#pragma warning restore 649

        [SerializeField]
        [Tooltip("If checked, the planes will match the geometry of the scanned environment; Unchecked will generate square planes.")]
        ...
        /// </summary>
        public bool UsePlaneGeometry
        {
            get => m_UsePlaneGeometry;
            set
            {
                m_UsePlaneGeometry = value;
                RecreatePlanes();
            }
        }
        ...
        /// </summary>
        public PlaneEdgeSettings EdgeSettings
        {
            get => m_EdgeSettings;
            set
            {
                m_EdgeSettings = value;
                RecreatePlanes();
            }
        }
        ...
        void Awake()
        {
            if (!this.HasProvider<IProvidesPlaneFinding>() || !this.HasProvider<IProvidesCameraOffset>())
        ...
        {
            if (MARSCore.instance.paused || m_PlanePrefab == null)
                return;
