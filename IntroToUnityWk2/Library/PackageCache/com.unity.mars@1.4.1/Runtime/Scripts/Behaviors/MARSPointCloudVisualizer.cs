...
namespace Unity.MARS.Visualizers
{
    ...
    public class MARSPointCloudVisualizer : MonoBehaviour, IUsesPointCloud, IUsesCameraOffset, ISimulatable
    {
        ...
        [SerializeField]
        [Tooltip("Defines the color for the low confidence points in the gradient.")]
        Color m_LowConfidenceColor = Color.red;

        [SerializeField]
        [Tooltip("Defines the color for the high confidence points in the gradient.")]
        ...
        {
            get => m_LowConfidenceColor;
            set => m_LowConfidenceColor = value;
        }

        /// <summary>
        /// Defines the color for the high confidence points in the gradient.
        /// </summary>
        public Color HighConfidenceColor
        {
            get => m_HighConfidenceColor;
            set => m_HighConfidenceColor = value;
        }
        ...
        void Awake()
        {
            if (!this.HasProvider<IProvidesPointCloud>() || !this.HasProvider<IProvidesCameraOffset>())
