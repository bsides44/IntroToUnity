...
namespace Unity.MARS
{
    ...
    public class MRFaceLandmarkVisualizer : MonoBehaviour, IUsesFaceTracking, IUsesCameraOffset, ISimulatable
    {
        ...
        [SerializeField]
        [Tooltip("Scale of the landmarks that are being displayed.")]
        float m_Scale = 0.01f; // 1cm

        /// <summary>
        /// Scale of the landmarks that are being displayed.
        /// </summary>
        public float Scale
        {
            get => m_Scale;
