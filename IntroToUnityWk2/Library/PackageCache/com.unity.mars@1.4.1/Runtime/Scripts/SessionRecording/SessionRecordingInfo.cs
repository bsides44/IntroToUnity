...
namespace Unity.MARS.Data.Recorded
{
    ...
    public class SessionRecordingInfo : ScriptableObject
    {
        ...
        /// <summary>
        /// Whether this recording has synthetic environments
        /// </summary>
        internal bool HasSyntheticEnvironments => m_SyntheticEnvironments.Count > 0;

        /// <summary>
        /// Whether this recording has a MarsVideoPlayableTrack and no data recording
        /// </summary>
        internal bool IsVideoOnly => HasVideo && m_DataRecordings.Count <= 0 && m_SyntheticEnvironments.Count <= 0;
