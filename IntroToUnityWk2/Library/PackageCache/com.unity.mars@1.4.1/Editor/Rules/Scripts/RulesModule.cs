...
namespace Unity.MARS.Rules.RulesEditor
{
    ...
    class RulesModule : IModule
    {
        ...
        static Action s_AfterHandlePick;
        ...
        internal static ProxyRuleSet RuleSetInstanceExisting
        {
            get
            {
                ...
                if (s_ProxyRuleSetInstance == null)
                {
                    ...
                    if (s_ProxyRuleSetInstance != null)
                    {
                        var root = s_ProxyRuleSetInstance.transform.root;
                        s_ProxyRuleSetInstance = root.GetComponentInChildren<ProxyRuleSet>();
                    }
                }
        ...
        internal static void HandlePicker()
        {
            ...
            s_AfterHandlePick?.Invoke();
            s_AfterHandlePick = null;
        }
        ...
        internal static void AfterHandlePick(Action afterPickCallback)
        {
            s_AfterHandlePick += afterPickCallback;
        }
        ...
        internal static GameObject CreateBuildSurfacePaint(UnityObject obj = null)
        {
        ...
        internal static GameObject CreateBuildSurfaceCollider()
        {
