...
namespace UnityEditor.MARS.Simulation
{
    ...
    public partial class MiniSimulationView : ScriptableObject, ISimulationView, ICompositeView
    {
        [NonSerialized]
        ...
        /// <inheritdoc />
        internal CompositeViewType CompositeViewType => CompositeViewType.OtherView;
        /// <inheritdoc />
        ...
        public void InitMiniSimulationView(float width, float height)
        {
            ...
            if (compositeRenderModule != null)
            {
                ...
                var compositeData = new CompositeRenderData(CompositeViewType, TargetCamera, CameraTargetDescriptor, BackgroundColor,
                    SimulationConstants.SimulatedEnvironmentLayerMask, ShowImageEffects, BackgroundSceneActive,
                    DesaturateComposited, UseXRay);

                compositeRenderBackground.InitializeCompositeBackground(compositeData);

                if (compositeRenderModule.TryGetCompositeRenderContext(camera, out var context))
                {
        ...
        public void SetupViewAsSimUser(bool forceFrame = false)
        {
            ...
            var compositeRenderModule = ModuleLoaderCore.instance.GetModule<CompositeRenderModule>();
            if (compositeRenderModule != null && m_Camera != null
