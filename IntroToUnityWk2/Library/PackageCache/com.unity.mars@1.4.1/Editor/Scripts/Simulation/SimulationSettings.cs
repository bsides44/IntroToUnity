...
#pragma warning disable 649
        ...
        [SerializeField]
        string m_SyntheticModeEnvironmentGuid;
...
#pragma warning restore 649
        ...
        public GameObject EnvironmentPrefab
        {
            ...
            set
            {
                if (EnvironmentMode == EnvironmentMode.Synthetic && value != null && AssetDatabase.TryGetGUIDAndLocalFileIdentifier(value, out var guid, out long _))
                    SyntheticModeEnvironmentGuid = guid;
        ...
        /// <summary>
        /// The guid of the environment prefab for the synthetic mode
        /// </summary>
        internal string SyntheticModeEnvironmentGuid
        {
            get { return m_SyntheticModeEnvironmentGuid; }
            private set { m_SyntheticModeEnvironmentGuid = value; }
        }
        ...
        public bool IsUsingRecording
        {
            get
            {
                return m_EnvironmentMode == EnvironmentMode.Recorded
                       || (m_EnvironmentMode == EnvironmentMode.Synthetic && m_UseSyntheticRecording);
            }
        }
        ...
        /// <summary>
        /// Set the recording for the supplied synthetic environment
        /// </summary>
        /// <param name="environmentPrefab">The target environment prefab</param>
        /// <param name="recording">The recording to set for the supplied synthetic environment</param>
        internal void SetRecordingForEnvironment(GameObject environmentPrefab, SessionRecordingInfo recording)
        {
            m_SyntheticRecordingsMap[environmentPrefab] = recording;
        ...
        {
            SetRecordingForEnvironment(m_EnvironmentPrefab, recording);
        }
