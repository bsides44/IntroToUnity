...
namespace Unity.MARS
{
    ...
    public abstract class ObjectCreationButtonData : ScriptableObject
    {
        ...
        /// </summary>
        [Obsolete("CreateInContext has been deprecated. Use UnityEditor.MARS.ObjectCreationData.CreateInContext instead")]
        public enum CreateInContext
        {
            /// <summary>
            /// (Obsolete) Creation takes place in the main editor scene
            /// </summary>
            [Obsolete("CreateInContext.Scene has been deprecated. Use UnityEditor.MARS.ObjectCreationData.CreateInContext.Scene instead")]
            Scene,
            /// <summary>
            /// (Obsolete) Creation takes place in the synthetic (environment) simulation scene
            /// </summary>
            [Obsolete("CreateInContext.SyntheticSimulation has been deprecated. Use UnityEditor.MARS.ObjectCreationData.CreateInContext.SyntheticSimulation instead")]
            SyntheticSimulation
        }
