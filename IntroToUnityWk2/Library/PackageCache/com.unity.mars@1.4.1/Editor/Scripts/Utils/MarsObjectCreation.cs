...
namespace UnityEditor.MARS.Authoring
{
    ...
    public static class MarsObjectCreation
    {
        ...
        /// <summary>
        /// Create a GameObject that is set up as a MARS Mesh Visuals Proxy
        /// </summary>
        /// <param name="parent">If specified, the new GameObject will be a child of this transform</param>
        /// <returns>The new GameObject</returns>
        public static GameObject CreateMeshVisualsPreset(Transform parent = null)
        {
            MarsObjectCreationResources.instance.MeshVisualsPreset.CreateGameObject(out var gameObject, parent);
            return gameObject;
        }
