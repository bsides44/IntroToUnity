...
namespace Unity.MARS
{
    class MarsSimulationSettingsProvider : SettingsProvider
    {
        ...
        SerializedObject m_SimulatedMeshingSettingsObject;
        SimulatedMeshingSettingsDrawer m_SimulatedMeshingSettingsDrawer;
        ...
        public static SettingsProvider CreateMARSPreferencesProvider()
        {
            ...
            keywordsList.AddRange(GetSearchKeywordsFromPath(AssetDatabase.GetAssetPath(SimulatedMeshingSettings.instance)));
        ...
        MarsSimulationSettingsProvider(string path = MARSCore.ProjectSettingsMarsRoot + "/Simulation", SettingsScope scope = SettingsScope.Project)
            : base(path, scope) { }
        ...
        public override void OnActivate(string searchContext, VisualElement rootElement)
        {
            ...
            var simulatedMeshingSettings = SimulatedMeshingSettings.instance;
            m_SimulatedMeshingSettingsObject = new SerializedObject(simulatedMeshingSettings);
            m_SimulatedMeshingSettingsDrawer = new SimulatedMeshingSettingsDrawer(m_SimulatedMeshingSettingsObject);
        }
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.LabelField("Simulated Meshing", EditorStyles.boldLabel);
            m_SimulatedMeshingSettingsDrawer.InspectorGUI(m_SimulatedMeshingSettingsObject);
            EditorGUIUtils.DrawBoxSplitter();
            EditorGUILayout.Space();
