...
namespace UnityEditor.MARS
{
    ...
    static class MarsEditorGUI
    {
        ...
        internal class MarsStyles
        {
            ...
            internal readonly GUIStyle DropDownItem;
            internal readonly GUIStyle GreyLabelStyle;

            internal MarsStyles()
            {
                var isProStyle = EditorGUIUtility.isProSkin;

                TopMarkerLibraryStyle = new GUIStyle(GUI.skin.GetStyle("Box"))
                {
                ...
                TabNext = isProStyle ? EditorGUIUtility.IconContent("d_tab_next").image
                ...
                DropDownItem = new GUIStyle("MenuItem")
                {
                    clipping = TextClipping.Overflow,
                    wordWrap = true,
                    ...
                    margin = LeftAlignedWrapLabel.margin,
                    border = LeftAlignedWrapLabel.border,
                    font = LeftAlignedWrapLabel.font,
                    fontSize = LeftAlignedWrapLabel.fontSize,
                };

                GreyLabelStyle = new GUIStyle(EditorStyles.whiteLabel)
                {
                    normal = { textColor = new Color(0.769f, 0.769f, 0.769f, 1f) } // #C4C4C4
                };
            }
        }
        ...
        internal class InternalEditorStylesSettings
        {
            ...
            internal readonly GUIStyle DropDownButton;
            ...
            public readonly GUIContent WarningIcon;
            public readonly GUIContent ErrorIcon;
            public readonly GUIContent HelpIcon;
            public readonly GUIContent TestPassedIcon;
            ...
            internal InternalEditorStylesSettings()
            {
                ...
                DropDownButton = GUI.skin.GetStyle("DropDownButton");
        ...
        /// <summary>
        /// Custom Popup Window for selecting Sync settings
        /// </summary>
        /// <inheritdoc />
        internal class SyncSettings : MarsPopupWindow
        {
            static readonly Vector2 k_PopupSize = new Vector2(280f, 57f);
            readonly ISimulationView m_SimView;

            public SyncSettings(ISimulationView view)
            {
                m_SimView = view;
            }
        ...
        internal static Rect GetDropDownButtonRect(GUIContent content, GUIStyle style, float height)
        {
            ...
            return GetDropDownButtonRect(style, height, GUILayout.Width(size.x));
        }

        internal static Rect GetDropDownButtonRect(GUIStyle style, float height, params GUILayoutOption[] options)
        {
            return EditorGUILayout.GetControlRect(false, height, style, options);
        }
